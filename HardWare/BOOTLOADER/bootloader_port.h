 ...
 * 说明：
 *   内部 Flash 按 512KB 规划为“运行区 / 备份区 / 缓存区”三块 152KB：
 *   - 运行区：0x0800D000 ~ 0x08032FFF。
 *   - 备份区：0x08033000 ~ 0x08058FFF。
 *   - 缓存区：0x08059000 ~ 0x0807EFFF。
 *   最后一页 0x0807F000 ~ 0x0807FFFF 暂不使用，作为保护和后续状态扩展预留。
 */
#define BOOTLOADER_PORT_PARAM_ADDR         0x0800C000UL
#define BOOTLOADER_PORT_BACKUP_ADDR        0x08033000UL
#define BOOTLOADER_PORT_DOWNLOAD_ADDR      0x08059000UL
#define BOOTLOADER_PORT_REGION_SIZE        (152U * 1024U)
...
#define BOOTLOADER_PORT_APP_MAX_SIZE       0x00026000UL
