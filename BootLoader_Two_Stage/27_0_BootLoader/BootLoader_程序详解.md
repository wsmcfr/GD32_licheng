...
| 下载缓存区 | `0x08070000` 起 | 旧 App 先把新固件下载到这里，BootLoader 下次启动时再搬运到正式 App 区。 |
...
| 4 | `Download_Transport()` | 分块从 `0x08070000` 读新固件，再写到 `0x0800D000`。 |
