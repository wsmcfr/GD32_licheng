...
- Project example: `project/2026706296.uvprojx` runs `fromelf.exe --bin --output=.\output\Project.bin .\output\Project.axf` after linking. The helper should not be allowed to convert a valid AXF build into a failed target.
