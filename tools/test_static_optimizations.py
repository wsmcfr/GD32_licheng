...
def main() -> None:
    ...
    analog = read_text("HardWare/ANALOG/bsp_analog.c")
    analog_h = read_text("HardWare/ANALOG/bsp_analog.h")
    usart = read_text("HardWare/USART/bsp_usart.c")
    ...
    require("SMART_STORAGE_ERR_IO" in read_text("HardWare/GD25QXX/smartfs_port.c"), "SMARTFS 未把底层 Flash 写擦失败映射为 IO 错误")
